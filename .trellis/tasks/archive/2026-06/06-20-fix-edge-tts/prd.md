...
- [ ] Edge TTS trên iOS không bị ngắt quãng giữa chừng khi nghe thời gian dài hoặc khi chạy nền.
- [ ] Edge TTS trên Android đổi giọng NamMinh phát ra đúng giọng nam, không bị chuyển sang giọng HoaiMy.
- [ ] Chức năng highlight từ hoạt động chính xác, đồng bộ với giọng đọc của cả tệp mp3.
- [ ] Các tác vụ tải trước (prefetch) được hủy kết nối thành công khi người dùng dừng phát hoặc chuyển chương.
- [ ] Code sạch sẽ, loại bỏ lớp `EdgeTtsStreamAudioSource` không còn sử dụng.
