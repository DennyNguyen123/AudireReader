...
void _bookSerialize(
  ...
  writer.writeLong(offsets[4], object.totalChapters);
...
Book _bookDeserialize(
  ...
  object.totalChapters = reader.readLong(offsets[4]);
...
extension BookByIndex on IsarCollection<Book> {
  ...
  Book? getByUuidSync(String uuid) {
  ...
  Future<List<Book?>> getAllByUuid(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
    return getAllByIndex(r'uuid', values);
  }

  List<Book?> getAllByUuidSync(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUuid(Book object) {
    return putByIndex(r'uuid', object);
  }

  Id putByUuidSync(Book object, {bool saveLinks = true}) {
    return putByIndexSync(r'uuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUuid(List<Book> objects) {
    return putAllByIndex(r'uuid', objects);
  }

  List<Id> putAllByUuidSync(List<Book> objects, {bool saveLinks = true}) {
...
extension BookQueryFilter on QueryBuilder<Book, Book, QFilterCondition> {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> uuidIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'uuid',
        value: '',
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> uuidIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'uuid',
        value: '',
