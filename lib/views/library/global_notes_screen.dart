...
class _GlobalNotesScreenState extends State<GlobalNotesScreen>
  ...
  Future<void> _loadData() async {
    ...
    for (var b in allBookmarks) {
      bookUuids.add(b.bookUuid);
    }
    for (var h in allHighlights) {
      bookUuids.add(h.bookUuid);
    }
          ...
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                ...
                Text(
                  'Ch. ${b.chapterIndex + 1} | Par. ${b.paragraphIndex + 1}',
                  style: TextStyle(
                    fontSize: 12,
            ...
            onTap: () =>
                _openLocation(b.bookUuid, b.chapterIndex, b.paragraphIndex),
          ),
        );
      },
    );
        ...
        try {
          if (h.colorHex.startsWith('#')) {
            highlightColor = Color(
              int.parse(h.colorHex.substring(1), radix: 16) + 0xFF000000,
            );
          }
        } catch (_) {}
          ...
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                const SizedBox(height: 8),
                Text(
                  'Ch. ${h.chapterIndex + 1} | Par. ${h.paragraphIndex + 1}',
                  style: TextStyle(
                    fontSize: 12,
                    color: Theme.of(context).colorScheme.primary,
                  ),
            ...
            onTap: () =>
                _openLocation(h.bookUuid, h.chapterIndex, h.paragraphIndex),
          ),
        );
      },
    );
