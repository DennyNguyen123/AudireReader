          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!.readingTheme,
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    color: labelColor,
                  ),
                ...
                Row(
                  children: ['System', 'Light', 'Dark', 'Sepia']
                      .map(
                        (theme) => _buildThemeButton(
                          theme,
                          isDark,
                          labelColor,
                          accentColor,
                ...
                const SizedBox(height: 8),
                Row(
                  children: ['Mint', 'Parchment', 'Navy', 'Custom']
                      .map(
                        (theme) => _buildThemeButton(
                          theme,
                          isDark,
                  ...
                  children: [
                    ...
                    SegmentedButton<String>(
                      ...
                      onSelectionChanged: (Set<String> newSelection) {
                        ...
                        widget.ttsService.updateSettings(
                          textAlignment: newSelection.first,
                        );
                      },
                    ),
                  ],
                ...
                if (_themeMode == 'Custom') ...[
                            ...
                            suffixIcon: IconButton(
                              ...
                              onPressed: () => _showColorPicker(
                                ...
                                (val) {
                                  ...
                                  widget.onCustomColorChanged(
                                    _customBackgroundColor,
                                    _customTextColor,
                                  );
                                  widget.ttsService.updateSettings(
                                    customBackgroundColor: val,
                                  );
                                },
                              ),
                            ),
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Enter hex color like #1A1A1A or FFFFFF and press Enter',
                ...
                Row(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context)!.showAssistiveButtonLabel,
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color: labelColor,
                      ),
                ...
                if (_showAssistiveButton) ...[
                  ...
                  Center(
                    child: TextButton.icon(
                      ...
                      label: Text(
                        AppLocalizations.of(context)!.resetButtonPosition,
